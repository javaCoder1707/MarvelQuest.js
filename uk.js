let answers = {
    ...
    "l": {
      "description" : "Вы - Локи бог обамна из Ётунхейма. Вы загадочный человек, вы Аратор, тактик и стратег можете обамнуть любого, но у вас очень скверный характер вы склонны к предательству у вас сильно развит интелект вы ни кому не доверяете  также вы хлоднокровный убийца который не в ком не нуждается вы живёте сам по себе, можете менять свой облик, обладаете телепортацией, клонированием и невидимостью  ",
      "image": "l.jpg",
    } ,
};